...
public class OrganizationController {
    ...
    public BaseResponse getOrgList(){
        ...
        try {
            List<Organization> orgList=organizationService.getOrgList(map);
    ...
    public BaseResponse saveOrg(@RequestBody  Organization org){
    ...
    public BaseResponse updateOrg(@RequestBody  Organization org){
