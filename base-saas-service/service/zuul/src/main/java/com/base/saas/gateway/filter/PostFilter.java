...
public class PostFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        //只有manager，system-web，scheduler使用日志
        String serviceId = String.valueOf(context.get("serviceId"));
        if (!serviceId.equals(ServerConstans.MANAGER) && !serviceId.equals(ServerConstans.SYSTEM_WEB) && !serviceId.equals(ServerConstans.SCHEDULER)){
            return null;
        }
