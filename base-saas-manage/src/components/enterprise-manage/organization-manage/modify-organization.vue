  ...
  <section class="component modify-organization" @click="treeShow=false">
    <el-form :model="modifyModel" :rules="rules" ref="modify-form" label-width="90px">
      ...
      <el-form-item label="上级组织" prop="parentOrgName"
                    :rules="modifyModel.parentOrgId=='#' ? {required: false} : {required: true, message: '请选择上级组织', trigger: 'blur'}">
        ...
        <div class="tree-wrapper" v-show="treeShow">
          <el-tree ref="modify_tree" :data="orgList" :props="defaultProps" @node-click="handleNodeClick"
