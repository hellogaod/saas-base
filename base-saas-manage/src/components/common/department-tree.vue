    ...
    <div style="display:flex">
      <el-col class="module">
        ...
        <div class="module-tree">
          <el-tree align="left" :data="treeResource" highlight-current :default-expanded-keys="[0]" node-key="orgId"
                   :props="{ label:'orgName'}" ref="tree" @current-change="onCurrentNodeChange"></el-tree>
        </div>
        <el-row class="title">
...
<script lang="ts">
  ...
  export default class ModulePermission extends Vue {
    ...
    refresh() {
      this.webOrganizationService.getOrgList().subscribe(
        data => {
