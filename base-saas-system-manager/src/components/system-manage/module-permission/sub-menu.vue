<template>
  <section class="component add-menu moduleAdd">
    ...
    <el-dialog title="选择图标" :append-to-body='true' class="iconDialog" v-model="subModel.icon" :center="true"
...
<script lang="ts">
  ...
  import iconDialog from "~/components/system-manage/module-permission/icon-dialog.vue";
