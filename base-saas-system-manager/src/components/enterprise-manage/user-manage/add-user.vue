  ...
  <div class="page add-user">
    <el-form :rules="rules" :model="addParams" ref="add-form" label-width="100px" align="left">
      ...
      <el-form-item label="备注" prop="remark">
        <el-col :span="21">
          <el-input type="textarea" v-model="addParams.remark" :autosize="{ minRows:2, maxRows:4}"
    ...
    <!--组织架构弹框-->
    <el-dialog title="组织架构树" :center="true" :visible.sync="addParams.treeShow" width="300px" append-to-body
               @open="$nextTick(()=>$refs['department-tree-dialog'].refresh())">
      <department-tree @close="addParams.treeShow = false" @getDepartment="getDepartment"
