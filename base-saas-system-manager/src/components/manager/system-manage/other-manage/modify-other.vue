  ...
  <section class="component modify-other">
    <el-form :model="modifyModel" :rules="rules" ref="modify-form" label-width="90px">
      <el-row>
        ...
        <el-col :span="6" align="right"><el-button @click="modifyRow">添加</el-button></el-col>
      </el-row>
      ...
      <div class="addRow">
        <el-row v-for="(item,index) in modifyModel.detailList" :key="index">
          <el-col :span="6">
            <el-form-item label="参数编码" align="left" :prop="'detailList.' + index + '.paraCode'" :rules="addRules.paraCode">
              <el-input v-model="item.paraCode" :maxlength="20"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="参数名称" align="left" :prop="'detailList.' + index + '.paraName'" :rules="addRules.paraName">
              <el-input v-model="item.paraName" :maxlength="20"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="排序值" align="left" :prop="'detailList.' + index + '.sortting'" :rules="addRules.sortting">
          ...
          <el-col :span="1">
            <el-button style="margin-left:20px" v-if="index===0" disabled  type="danger" size="mini" icon="el-icon-delete"  circle @click="deleteRow(index)"></el-button>
            <el-button style="margin-left:20px" v-if="index>0" type="danger" size="mini" icon="el-icon-delete"  circle @click="deleteRow(index)"></el-button>
          </el-col>
        </el-row>
      </div>
...
import { OtherService } from "~/services/manager-services/other.service";
