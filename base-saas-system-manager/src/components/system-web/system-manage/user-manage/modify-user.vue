  ...
  <div class="page modify-user">
    <el-form :rules="rules" :model="modifyParams" ref="modify-form" label-width="100px" align="left">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="组织架构" prop="orgName">
            <el-input v-model="modifyParams.orgName" size="small" :maxlength="25" :readonly="true" @click.native="showDepartmentTree()"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item label="备注" prop="remark">
        <el-col :span="21">
          <el-input type="textarea" v-model="modifyParams.remark" :autosize="{ minRows:2, maxRows:4}" :maxlength="100"></el-input>
        </el-col>
      </el-form-item>
    ...
    <!--组织架构弹框-->
    <el-dialog title="组织架构树" :center="true" :visible.sync="treeShow" width="300px" append-to-body @open="$nextTick(()=>$refs['department-tree-dialog'].refresh())">
      <department-tree @close="treeShow = false" @getDepartment="getDepartment"  ref="department-tree-dialog"></department-tree>
    </el-dialog>
  </div>
</template>
<script lang="ts">
