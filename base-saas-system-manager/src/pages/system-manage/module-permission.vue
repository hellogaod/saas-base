...
<script lang="ts">
  ...
  import {ModuledetailService} from "~/server/services/system-manage-services/moduleDetail.service";
  import {Prop, Emit, Watch} from "vue-property-decorator";
  import {Auth, Layout, Dependencies} from "~/core/decorator";
  import {DataTransferUtil} from "~/utils/datatransfer.util";
  import addMenu from "~/components/system-manage/module-permission/add-menu.vue";
  import subMenu from "~/components/system-manage/module-permission/sub-menu.vue";
  import editMenu from "~/components/system-manage/module-permission/edit-menu.vue";
