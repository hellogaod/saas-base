...
<script lang="ts">
  ...
  import addModular from "~/components/system-manage/module-manage/add-modular.vue";
  import modifyModular from "~/components/system-manage/module-manage/modify-modular.vue";
