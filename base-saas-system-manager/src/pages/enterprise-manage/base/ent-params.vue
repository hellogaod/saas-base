      ...
      <div class="item-wrapper" v-for="item in paramsModel.threeParams" :key="item.otherName">
        ...
        <div class="content">
          <div class="form-group" v-for="itm in item.paramDetail" :key="itm.paraName">
            <label class="input-label"><p>{{itm.remark}}</p>
              <p>{{itm.paraName}}:</p></label>
...
<script lang="ts">
  ...
  import {webSystemParamsService} from "~/server/services/enterprise-manage-services/ent-params.service";
