<template>
  ...
  <section class="page system-company">
    <el-row>
      <el-col :span="24" align="right"><el-button class="saveBtn" @click="commit">保存</el-button>  </el-col>
    </el-row>
...
import { companyProfile } from "~/services/systemweb-services/companyProfile.service";
@Layout('workspace')
@Component({
  components: {
    DataEditor,
